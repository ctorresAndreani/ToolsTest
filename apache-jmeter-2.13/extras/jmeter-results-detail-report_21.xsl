		...
		<head>
			...
			<script language="JavaScript"><![CDATA[
			   ...
			   function change(details_id)
			   {
			      ...
			      {
			         document.getElementById(details_id+"_image").src = "http://i61.tinypic.com/2cdik4n.png";
			         expand(details_id);
			      }
			      else
			      {
			         document.getElementById(details_id+"_image").src = "http://i60.tinypic.com/vzkfbs.png";
			         collapse(details_id);
			      } 
                           }
			]]></script>
			...
			<tr valign="top">
				...
				<td align="center">
				   <a href="">
				      ...
				      <img src="http://i61.tinypic.com/2cdik4n.png" alt="expand/collapse"><xsl:attribute name="id"><xsl:text/>page_details_<xsl:value-of select="position()" />_image</xsl:attribute></img>				      
				   </a>
				</td>
			</tr>
